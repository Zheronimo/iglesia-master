...
function aletheme_metaboxes($meta_boxes) {
    ...
    $meta_boxes[] = array(
     ...
     $meta_boxes[] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => __('Services Icon 1','aletheme'),
                'desc' => 'Upload or select an image',
                'id'   => $prefix . 'services_icon1',
                'std'   =>'',
                'type' => 'file',
            ),
             array(
                ...
                'std'   =>'Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type',
                'type' => 'textarea_code',
            ),
              array(
                'name' => __('Services Icon 2','aletheme'),
                'desc' => 'Upload or select an image',
                'id'   => $prefix . 'services_icon2',
                'std'   =>'',
                'type' => 'file',
            ),
             array(
              ...
              array(
                'name' => __('Services Icon 3','aletheme'),
                'desc' => 'Upload or select an image',
                'id'   => $prefix . 'services_icon3',
                'std'   =>'',
                'type' => 'file',
            ),
             array(
              ...
              array(
                'name' => __('Services Icon 4','aletheme'),
                'desc' => 'Upload or select an image',
                'id'   => $prefix . 'services_icon4',
                'std'   =>'',
                'type' => 'file',
            ),
             array(
    ...
    $meta_boxes[] = array(
            ...
            'priority'   => 'high',
            'show_names' => true, // Show field names on the left
            'show_on'    => array( 'key' => 'page-home', 'value' => array('page-home.php'), ), // Specific post templates to display this metabox
            ...
            array(
                'name' => __('Description for Our Sermons','aletheme'),
                'desc' => 'Insert the text',
